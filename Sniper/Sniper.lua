...
-- v6.15.259: CATEGORY_CHAINS extracted to lib/threat_data.lua so other hero
-- brains can consume the same category-keyed defaults. The Sniper-coupled
-- entries (grenade_self / grenade_at_caster) currently live in the lib
-- chains; v6.15.260 will move them to Sniper-side overrides and make the
-- lib chains fully hero-agnostic.
local CATEGORY_CHAINS = TD.CATEGORY_CHAINS
